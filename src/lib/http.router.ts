...
export interface HttpRouter {
  ...
  set404NotFoundHandler(handler: (ctx: HttpContext, next: () => Promise<void>) => Promise<void>): void;
  set500ErrorHandler(handler: (ctx: HttpContext, next: () => Promise<void>) => Promise<void>): void;
